...
* group[=].element[=].target.code = #DiagnosticReport.attester					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #relatedto					
...
* group[=].element[=].target.code = #DiagnosticReport.section					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #relatedto					
...
* group[=].element[=].target.code = #DiagnosticReport.section:sectionAllergies					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
...
* group[=].element[=].target.code = #DiagnosticReport.section:sectionImmunizations					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
...
* group[=].element[=].target.code = #DiagnosticReport.section:sectionPastIllnessHx					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
...
* group[=].element[=].target.code = #DiagnosticReport.sectionAdvanceDirectives					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
					
* group[=].element[+].code = #PatientSummary.body.results					
* group[=].element[=].display = "A.2.8 - Results"					
* group[=].element[=].target.code = #DiagnosticReport.section:sectionResults					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
					
* group[=].element[+].code = #PatientSummary.body.planOfCare					
* group[=].element[=].display = "A.2.9 - Plan of Care"					
* group[=].element[=].target.code = #DiagnosticReport.section:sectionPlanOfCare					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
